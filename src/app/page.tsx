...
export default function Home() {
  return (
    <div className="bg:gridient-to-r from bg-cyan-800 to-cyan-800">
      ...
      <a className="mr-5 text-white font-semibold hover:text-indigo-300 transition-all duration-300 ease-in-out transform hover:scale-110" href='/privacy policy'>Privacy policy</a>
...
<section className="bg-gradient-to-r from-gray-800 to-gray-800 body-font bg-gray-200 blog-section">
    ...
    <div className="flex flex-wrap -m-4">
      ...
      <div className="p-4 md:w-1/3">
        <div className="h-full border-2 border-gray-300 border-opacity-60 rounded-lg overflow-hidden bg-yellow-600 shadow-lg">
          <Image className="lg:h-48 md:h-36 w-full object-cover object-center" src="/currencyimage.jpg" alt="blog" 
          height={200}
          width={200}/>
          <div className="p-6">
      ...
      <div className="p-4 md:w-1/3">
        <div className="h-full border-2 border-gray-300 border-opacity-60 rounded-lg overflow-hidden bg-yellow-600 shadow-lg">
          <Image className="lg:h-48 md:h-36 w-full object-cover object-center" src="/timerimage.jpg" alt="blog" 
          height={200}
          width={200}/>
          <div className="p-6">
      ...
      <div className="p-4 md:w-1/3">
        <div className="h-full border-2 border-gray-300 border-opacity-60 rounded-lg overflow-hidden bg-yellow-600 shadow-lg">
          <Image className="lg:h-48 md:h-36 w-full object-cover object-center" src="/advanturegame.jpg" alt="blog" 
          height={200}
          width={200}/>
          <div className="p-6">
  ...
  <div className="container px-5 py-24 mx-auto">
    ...
    <button className="bg-gray-100 flex mx-auto py-3 px-5 rounded-lg items-center hover:bg-pink-400 focus:outline-none ">
       <Image className='w-10 h-18' src="/githupimag.jpg" alt="git"
       height={100}
       width={100}/>
    ...
    <div className="flex flex-wrap -m-2">
      <div className="p-2 lg:w-1/3 md:w-1/2 w-full">
        <div className="h-full flex items-center border-gray-200 border p-4 rounded-lg">
          <Image alt="team" className="w-16 h-16 bg-gray-100 object-cover object-center flex-shrink-0 rounded-full mr-4" src="/catoonimg.jpg"
          height={50}
          width={50}/>
      ...
      <div className="p-2 lg:w-1/3 md:w-1/2 w-full">
        <div className="h-full flex items-center border-gray-200 border p-4 rounded-lg">
          <Image alt="team" className="w-16 h-16 bg-gray-100 object-cover object-center flex-shrink-0 rounded-full mr-4" src="/boycartoon.jpg"
          height={50}
          width={50}/>
          <div className="flex-grow">
